...
import { PENDING_DEMOS, LOST_REASONS, FOLLOW_UP_OPTIONS, type PendingDemo } from '@/data/mock'
...
export default function SalesPage() {
  ...
  const [pendingDemos, setPendingDemos] = useState<PendingDemo[]>([...PENDING_DEMOS])
